                        ...
                        <div class="property-image">
                            ${galleryHtml}
                                                ...
                                                <div class="property-info">
                                                    ...
                                                    <p style="margin:0 0 14px 0;font-size:0.9em;line-height:1.4;color:#374151;background:#f8fafc;border:1px solid #dbeafe;border-radius:8px;padding:10px 12px;"><strong>Info costi:</strong> include tutti i servizi: aria condizionata, tassa di soggiorno, pulizie e pass parcheggio. Le lenzuola non sono incluse: gli ospiti le portano con sé. <strong>Caparra:</strong> 20% dell'importo totale.</p>
