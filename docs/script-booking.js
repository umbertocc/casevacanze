                    ...
                    <div class="property-card" style="margin-bottom: 68px;">
                        ...
                        <div class="property-info">                            
                            ...
                            <div style="margin-top: 18px; margin-bottom: 10px;">
                               <a href="#" class="prenota-btn" id="${btnId}" style="color: #48bb78; text-decoration: underline; font-weight: 500; display: block; margin-bottom: 10px; font-size:1.24em">📋 Richiesta info</a> 
