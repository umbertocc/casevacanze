                    ...
                    <div class="property-card" style="margin-bottom: 68px;">
                        ...
                        <div class="property-info">
                            ...
                            <div style="margin-top: 18px; margin-bottom: 10px;">
                                <a href="#" class="prenota-btn" id="${btnId}" style="color: #48bb78; text-decoration: underline; font-weight: 500; display: block; margin-bottom: 10px;">📋 Richiedi preventivo</a>
                        ...
                        btn.onclick = (e) => { e.preventDefault();
                            ...
                            modalBody.innerHTML = `
                                ...
                                <form id=\"prenotaForm\">
                                    ...
                                    <div style=\"margin-bottom:10px;\"><input required name=\"persone\" type=\"number\" min=\"1\" max=\"20\" placeholder=\"Numero di Persone\" style=\"width:100%;padding:8px;margin-bottom:6px;border-radius:5px;border:1px solid #ccc;\"></div>
