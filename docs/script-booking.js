...
function openPreventivoRequestModal(appartamento, prezzoTotale, checkIn, checkOut, casaId) {
    ...
    modalBody.innerHTML = `
        <div style="margin:10px 0 12px 0;display:flex;justify-content:space-between;align-items:center;gap:10px;">
            <h2 style="margin:0;font-size:1.2em;color:#2d7a46;">Invia richiesta</h2>
        </div>
        <p style="margin:0 0 12px 0;color:#4b5563;font-size:0.95em;">Compila i dati per inviare la richiesta di disponibilita.</p>
                    ...
                    <div class="property-card" style="margin-bottom: 68px;">
                        ...
                        <div class="property-info">                            
                            ...
                            <div style="margin-top: 18px; margin-bottom: 10px;">
                               <a href="#" class="prenota-btn" id="${btnId}" style="color: #48bb78; text-decoration: underline; font-weight: 500; display: block; margin-bottom: 10px; font-size:1.24em">📋 Invia richiesta</a> 
